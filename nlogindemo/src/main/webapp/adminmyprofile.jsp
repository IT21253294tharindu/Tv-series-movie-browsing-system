...
<body id="#top">
     ...
     <h4 >Profile Settings</h4><br></br>
             ...
             <c:forEach var="u" items="${admindetails}">
              <tr>
              <td>user id</td>
              <td>${u.id}</td>
              </tr>
        ...
        <center>  <div class="mt-5 text-center"><button class="btn btn-primary profile-button" type="button">Save Profile</button></div></center>
     </div></center>
    ...
    <div class="container">
      ...
      <nav class="navbar" data-navbar>
        ...
        <ul class="navbar-list">
          ...
          <li>
            <a href="adminhomepage.jsp" class="navbar-link">Home</a>
          </li>
